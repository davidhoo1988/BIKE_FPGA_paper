...
\subsection{Generation of Polynomials with Prescribed Weight}
...
\multirow{3}{*}{\textbf{BIKE-1}} & 128 & Ours, constant-time & FPGA & 0.095\\
                                & 128 & \cite{aragon2017bike}, non-constant-time & {\color{red} CPU name} & $\approx 0.73$\\
                                & 128 & \cite{drucker2017toolbox}, {\color{red} constant-time?} & {\color{red} CPU name} & 0.09\\
\hline
\multirow{3}{*}{\textbf{BIKE-2}} & 128 & Ours, constant-time & FPGA & 2.15\\
                                & 128 & \cite{aragon2017bike}, {\color{red} constant-time?} & {\color{red} CPU name} &$\approx 6.3$\\
                                & 128 & \cite{drucker2017toolbox}, {\color{red} constant-time?}& {\color{red} CPU name} & 4.38\\
                                 % & 80 & \cite{maurich2015implementing} & Micro-controller &$\approx 148.5$\\
\hline
\multirow{2}{*}{\textbf{BIKE-3}} & 128 & Ours, constant-time & FPGA & 0.098\\
                                 & 128 & \cite{aragon2017bike}, {\color{red} constant-time?} & {\color{red} CPU name} &$\approx 0.43$ \\
\hline
\end{tabular}}
\end{minipage}
\vspace{-4mm}
