...
%\caption{Cycle count for computing one block in Generic Multiplication}
...
%\begin{table}[!tb]\centering
%\caption{Cycle count for extracting $d$ bits of $x^ib(x)$ in Sparse Polynomial Multiplication{\color{red} you did not mention this table anywhere in the text}}
...
%\begin{table}[!tb]\centering
%\caption{Cycle count for generating  one entry of a random polynomial with odd weight}
%\begin{tabular}{c|c|c|c}
%  \hline
%  % after \\: \hline or \cline{col1-col2} \cline{col3-col4} ...
...
%
%\begin{table}[!tb]\centering
%\caption{Cycle count for generating  the i-th entry (i=1,2,...) of a random sparse polynomial with odd weight}
...
quasi-cyclic codes. In addition, we re-implement our design and compare fairly with the FPGA implementation from the classic-McEliece NIST submission specification document published in 2019 \cite{bernstein2019classic}, on the platform of Xilinx Artix-7. The results show that  the timing and the area advantages of our work still preserve.
...
\hline
Scheme &\tabincell{c}{SL\\{} [bit]}&Platform &$f$[MHz] & Time/Op & Cycles  & Slices/LUTs/FFs & BRAM\\
\hline
MDPC code:\\
\textbf{Ours (BIKE-1)} & \multirow{3}{*}{\textbf{128}} & \multirow{3}{*}{Artix-7} & {\textbf{165}}  & $\mathbf{0.578 ms}$& $9.55\times 10^4$  & \textbf{608/1907/1049} & \textbf{7}\\
\textbf{Ours (BIKE-2)} &  &  & {\textbf{160}}  & $\mathbf{13.437 ms}$& $2.15\times 10^6$  & \textbf{1312/3874/2141} & \textbf{10}\\
\textbf{Ours (BIKE-3)} &  &  & {\textbf{170}}  & $\mathbf{0.579 ms}$& $9.85\times 10^4$  & \textbf{453/1397/925} & \textbf{4}\\
\hline
Goppa code:\\
\cite{wang2018fpga} &{256} &{Virtex Ultrascale+} & {225}   & $3.98ms$    & $\approx 1.01\times 10^{11}$  & {---/112845/---}& {375}\\
\cite{wang2018fpga} &{103} &{Virtex-5} & {168}   & $16 ms$    & $\approx 2.72\times 10^6$  & {8171/19257/20622}& {89}\\
\cite{bernstein2019classic}&{128} &{Artix-7} & {38.1}   & $41.9 ms$    & $\approx 1.59\times 10^6$  & {---/25327/49383}& {168}\\
%\cite{},time optimized &{128} &{Artix-7} & {28.6}   & $7.06 ms$    & $\approx 2.02\times 10^5$  & {---/81339/132190}& {236}\\
